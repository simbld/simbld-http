...
generate_responses_functions! {
  ...
  Created => (201, "Created", "Created", "Request processed successfully and document created, with a new resource created, and the URI of the new resource returned, if available", 201, "Created"),
  ...
  TransformApplied => (200, "OK", "The response represents the result of a transformation or conversion applied to the resource, and the response body contains the transformed resource, such as a transcoded media file, or a formatted document", 214, "Transform Applied"),

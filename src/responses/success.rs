...
/// ```rust
///
/// use simbld_http::responses::success::ResponsesSuccessCodes::Created;
///
...
generate_responses_functions! {
  Ok => (200, "OK", "Request processed successfully. Response will depend on the request method used, and the result will be either a representation of the requested resource or an empty response", 200, "Ok", 0, "", "", ""),
  Created => (201, "Created", "Request processed successfully and document created, with a new resource created, and the URI of the new resource returned, if available", 201, "Created", 0, "", "", ""),
  Accepted => (202, "Accepted", "Request processed, but with no guarantee of results, and no indication of the final status of the request, which will be processed asynchronously, such as a request to create a new resource", 202, "Accepted", 0, "", "", ""),
  NonAuthoritativeInformation => (203, "Non-Authoritative Information", "Information returned, but generated by an uncertified source, such as a proxy server, rather than the origin server, and may be incorrect, outdated, or otherwise unreliable", 203, "NonAuthoritativeInformation", 0, "", "", ""),
  NoContent => (204, "No Content", "Request processed successfully but no information to return, and the response body is empty, useful as a header for a DELETE request, indicating that the resource has been deleted", 204, "NoContent", 0, "", "", ""),
  ResetContent => (205, "Reset Content", "Request processed successfully, current page can be deleted, and the client should reset the document view, useful as a header for a form submission, indicating that the form has been processed successfully", 205, "ResetContent", 0, "", "", ""),
  PartialContent => (206, "Partial Content", "Only part of the resource was transmitted, as the request used the Range header to retrieve a specific portion of the resource, and the response contains the requested range, or the server is unable to return the entire resource", 206, "PartialContent", 0, "", "", ""),
  MultiStatus => (207, "Multi-Status", "Multiple status responses, with a separate response code for each part of the request, and the response body contains XML that describes the status of each part of the request, useful for WebDAV RFC 4918", 207, "Multi-Status", 0, "", "", ""),
  AlreadyReported => (208, "Already Reported", "A WebDAV binding has been enumerated in a previous http code 207 and are not included here again, useful for WebDAV RFC 5842", 208, "Already Reported", 0, "", "", ""),
  IMUsedGetRequest => (226, "IM Used", "The server has completed the resource request, responded to a GET request, and the response is a representation of the current instance, indicating that the server has completed the resource request and responded to a GET request, and the response body contains the current instance of the resource", 226, "IM Used Get Request", 0, "", "", ""),
  ContentDifferent => (200, "OK", "The client-side copy of the resource differs from the server-side copy (content or properties), the content of the response has a different meaning depending on the media type that is returned, and the response body may contain a representation of the requested resource, or some instructions on how to process the request", 210, "Content Different", 0, "", "", ""),
  ContentLocation => (200, "OK", "The response provides a URL for accessing a resource that is the result of the requested action", 211, "Content Location", 0, "", "", ""),
  ObjectData => (200, "OK", "The response contains the representation of an object’s data, and the response body contains the data of the object, such as a JSON object or XML document, and the response body may contain the requested resource", 212, "Object Data", 0, "", "", ""),
  MultipleResourceInstances => (200, "OK", "The response indicates multiple instances of the requested resource exist, each with its own set of properties, and the response body contains an array of resources, each with its own set of properties", 213, "Multiple Resource Instances", 0, "", "", ""),
  TransformApplied => (200, "OK", "The response represents the result of a transformation or conversion applied to the resource, and the response body contains the transformed resource, such as a transcoded media file, or a formatted document", 214, "Transform Applied", 0, "", "", ""),
  ContentDeleted => (200, "OK", "The requested resource has been deleted, and the response body contains the status of the deletion, and the response body may contain the requested resource", 215, "Content Deleted", 0, "", "", ""),
  IMUsedPostRequest => (200, "OK", "The server has completed the resource request, responded to a POST request, and the response is a representation of the result of one or more instance manipulations applied to the current instance", 216, "IM Used Post Request", 0, "", "", ""),
  DeltaEncodingApplied => (200, "OK", "The response contains the result of a partial modification to the resource, and the response body contains the modified resource, such as a JSON patch document or a binary diff, the response is a delta encoding of the requested resource, containing only the changes between the current and previous versions", 217, "Delta Encoding Applied", 0, "", "", ""),
  ThisIsFine => (200, "OK", "Everything is fine, and the response body contains a humorous or playful message, indicating that the server is aware of the situation and is not concerned, The server is returning this response to indicate that everything is working as expected, even though the situation may be unusual or unexpected, apache, unofficial", 218, "This Is Fine", 0, "", "", ""),
  ContentTransferred => (200, "OK", "The response contains the transferred content, and the response body contains the content that was transferred, such as a file or document, and the response body may contain the requested resource, the response indicates that the content has been transferred successfully to another instance, thus ending the current instance", 219, "Content Transferred", 0, "", "", ""),
  LoadBalancerStarted => (200, "OK", "The server has started a load balancer, and the response body contains the status of the load balancer, indicating that the server has initiated a load balancer to distribute incoming requests across multiple servers, the server response is sent by a load balancer to notify the client that a new server load balancing process has started", 220, "Load Balancer Started", 0, "", "", ""),

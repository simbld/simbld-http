...
impl ResponsesInformationalCodes {
  ...
  pub fn description(&self) -> &'static str {
    match self {
      ...
      ResponsesInformationalCodes::Processing => "Indicates the server is processing the request but has not yet finished, used to prevent timeout errors in asynchronous operations, webdav
RFC 2518",
